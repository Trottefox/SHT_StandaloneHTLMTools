...
SHT_Memory_flashcards : A tool for teachers made for making simple flashcards as memory reactivator for students.
...
SHT_OCR_Image2text(fully disconnected) : A tool to identify the text on a photo, heavy but totally disconnected. Relies on tesseract.
SHT_OCR_Image2text(light connects once) : A lighter version of the previous one, that needs to load the language file once before being able to work disconnected
